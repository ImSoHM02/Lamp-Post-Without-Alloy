...
elseif GetModConfigData("recipe") == 2 then
	_Ingredient = Ingredient("gears", 5)
...
TUNING.CITYLAMP_AURA = GetModConfigData("lightauras")
...
AddRecipe2(
	...
	TECH.SCIENCE_TWO, "city_lamp_placer", {"LIGHT"})
	RegisterInventoryItemAtlas("images/inventoryimages/city_lamp.xml", "city_lamp.tex")
